...
public class MongoConnectionRepository implements ConnectionRepository {
	...
	public MongoConnectionRepository(String userId, ConnectionService connectionService, ConnectionFactoryLocator connectionFactoryLocator, TextEncryptor textEncryptor) {
		this.userId = userId;
